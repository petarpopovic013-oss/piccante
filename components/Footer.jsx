        ...
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="md:col-span-5 space-y-8">
            ...
            <div className="flex gap-5 pt-2">
              <a href="#instagram" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#C22127] hover:text-white hover:border-[#C22127] transition-all duration-300">
              ...
              <a href="#facebook" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#C22127] hover:text-white hover:border-[#C22127] transition-all duration-300">
